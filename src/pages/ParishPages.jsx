      ...
      <div className="container" style={{ maxWidth: '850px' }}>
        ...
        <div className="grid-2">
          ...
          <div style={{ background: 'var(--cream)', padding: '1.75rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-gold)' }}>
            ...
            <p style={{ fontSize: '0.9rem', lineHeight: '1.8' }}>
              <strong>Address:</strong> Our Lady of Loretto Church, Loretto, Mangalore<br />
              <strong>Phone:</strong> [PLACEHOLDER — Office Phone]<br />
              <strong>Email:</strong> [PLACEHOLDER — Office Email]
            </p>
          </div>
        </div>
      </div>
