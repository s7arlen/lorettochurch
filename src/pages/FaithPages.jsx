    ...
    <section className="section section--cream">
      <div className="container" style={{ maxWidth: '850px' }}>
        ...
        <div style={{ background: 'var(--warm-white)', padding: '2rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--border-gold)', marginBottom: '1.5rem' }}>
          <h3 style={{ fontFamily: 'var(--font-serif)', fontSize: '1.4rem', color: 'var(--brown-primary)', marginBottom: '0.5rem' }}>Novena to Our Lady of Loretto</h3>
          <p style={{ fontStyle: 'italic', lineHeight: '1.8', color: 'var(--brown-primary)' }}>
            "O Most Holy Virgin Mary, Mother of Grace and Mercy, patroness of our Loretto parish, we entrust our lives, our families, and our intentions to your loving protection. Intercede for us before God. Amen."
          </p>
        </div>
      </div>
    </section>
