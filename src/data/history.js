// [PLACEHOLDER] — Replace with actual parish history details
...
export const parishFacts = [
  { label: 'Diocese', value: 'Diocese of Mangalore' },
  { label: 'Parish', value: 'Our Lady of Loretto' },
  { label: 'Location', value: 'Loretto, Mangalore, Karnataka' },
  { label: 'Patron', value: 'Our Lady of Loretto' },
  { label: 'Feast Day', value: 'December 10' },
  { label: 'Parish Priest', value: '[PLACEHOLDER]' },
];
