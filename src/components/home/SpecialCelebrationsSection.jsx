      ...
      <div className="container">
        <div className="celebrations__banner">
          ...
          >
            ...
            <h2 className="celebrations__title">Feast of Our Lady of Loretto</h2>
            
            <p className="celebrations__text">
              Every year in December, the parish family comes together with profound devotion to celebrate the feast day of our patroness, Our Lady of Loretto. The festivity features solemn Nine-Day Novenas, grand concelebrated High Mass, traditional procession, illuminations, and community fellowship.
            </p>
            ...
            <div className="celebrations__details">
              ...
              <div className="celebrations__detail-item">
                ...
                <span>Feast Day: December 10</span>
              </div>
            </div>
